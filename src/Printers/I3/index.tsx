...
const I3 = ({ printerConfig }) => {
    ...
    const printing = (cus_attr || cus_entity?.state || (hass.states[config.use_mqtt ? `${config.base_entity}_print_status` : `${config.base_entity}_current_state`] || { state: "unknown" }).state) === ('Printing' || 'Running');
